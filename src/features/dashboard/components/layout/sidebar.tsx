...
import { Popover, Input, PopoverContent, PopoverTrigger } from "@/shared/components/ui"
import { Settings, LogOut, User, Bell, UserPlus, Shield, Laptop, Moon, Wallet } from 'lucide-react'
          ...
          <Popover>
            <PopoverTrigger asChild>
              <button className="group relative flex h-10 w-full items-center text-neutral-400 transition-all duration-300 ease-in-out hover:text-white cursor-pointer">
                ...
                >
                  <span className="text-sm font-medium">remcostoeten</span>
                  <span className="text-xs text-neutral-500">remcostoeten..hotm...</span>
                </div>
              </button>
            </PopoverTrigger>
            <PopoverContent className="w-80 p-2 bg-[#0A0A0A] border border-[#1f1f1f] rounded-lg shadow-xl z-[100]" align="end" sideOffset={5}>
                ...
                <div className="p-2">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm font-medium text-white">remcostoeten</span>
                      <span className="text-xs text-neutral-500">remcostoeten..hotmail.com</span>
