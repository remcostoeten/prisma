...
import {Tabs, TabsContent, TabsList, TabsTrigger , Popover, PopoverContent, PopoverTrigger } from "@/shared/components/ui"
        ...
        <Tabs defaultValue="inbox" className="w-full">
          ...
          >
            <div className="flex min-h-[350px] flex-col items-center justify-center gap-2 p-8 text-center">
              ...
              <div className="text-sm font-medium text-white">No archived notifications</div>
              <div className="text-xs text-neutral-400">
