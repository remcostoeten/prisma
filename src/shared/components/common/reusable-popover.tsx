...
export const PopoverSection: React.FC<PopoverSectionProps> = ({ children, className }) => (
...
export const ReusablePopover: React.FC<ReusablePopoverProps> = ({
  ...
  return (
    <Popover>
      ...
      <PopoverContent 
        className={cn("w-80 p-2 bg-[#0A0A0A] border border-[#1f1f1f] rounded-lg shadow-xl z-[100]", className)} 
        align={align}
        side={side}
...
export const PopoverDivider: React.FC = () => <div className="h-px bg-[#1f1f1f]" />

export const PopoverBanner: React.FC<{ children: React.ReactNode }> = ({ children }) => (
