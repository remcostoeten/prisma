          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-lg border border-border bg-card p-4 space-y-3">
                <Button variant="default" className="w-full" style={{ backgroundColor: accentColor }}>
                  Primary Button
                </Button>
                <Button variant="outline" className="w-full border-2" style={{ borderColor: accentColor }}>
                  Outline Button
                </Button>
