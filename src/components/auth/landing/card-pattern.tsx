...
import { DEFAULT_SPOTLIGHT_SIZE, DEFAULT_SPOTLIGHT_COLOR, DEFAULT_SPOTLIGHT_STRENGTH, DEFAULT_TEXT_COLOR, DEFAULT_TEXT_SIZE } from '@/shared/constants/defaults'
import { CardPatternProps } from '@/types/card'
